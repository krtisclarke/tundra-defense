...
(function () {
  ...
  const THEME_EXTRAS = {
    shores:  { snow: '#f2f8fc', ice: '#d5e9f6', pathColor: '#e3d3b2', pathEdge: '#c2ac85', pathCore: '#efe3c8', deep: '#2e6da4', shore: '#bfe0ea', props: 'pines' },
    pass:    { snow: '#eef3f9', ice: '#cddff0', pathColor: '#cfd6de', pathEdge: '#a4b0bf', pathCore: '#dfe5ec', deep: '#33689e', shore: '#b8d8e6', props: 'pines' },
    river:   { snow: '#eef7f6', ice: '#cfe7ea', pathColor: '#decdaa', pathEdge: '#bda887', pathCore: '#eadfc2', deep: '#1e7392', shore: '#a3d8dc', props: 'reeds' },
    alley:   { snow: '#eaf2fa', ice: '#cadff2', pathColor: '#d5dbe2', pathEdge: '#aab5c3', pathCore: '#e4e9ee', deep: '#275e91', shore: '#b0d3e8', props: 'floes' },
    village: { snow: '#f4f7fb', ice: '#dbe8f4', pathColor: '#e6d5b4', pathEdge: '#c4b08c', pathCore: '#f1e6cc', deep: '#2e6da4', shore: '#bfe0ea', props: 'village' },
    caves:   { snow: '#9aa5c4', ice: '#6f7ca8', pathColor: '#5c688e', pathEdge: '#414d73', pathCore: '#6d7999', deep: '#274067', shore: '#5d78a0', props: 'crystals', glow: '#7fd8f5' },
    ridge:   { snow: '#e6e9f6', ice: '#c2cdec', pathColor: '#cfc2a6', pathEdge: '#ac9c80', pathCore: '#ded3bc', deep: '#2b5f94', shore: '#aecfe6', props: 'pines' },
    bay:     { snow: '#e9f3f1', ice: '#cbe5e1', pathColor: '#dbc8a4', pathEdge: '#b7a380', pathCore: '#e8dabc', deep: '#166781', shore: '#9fd4cd', props: 'bay' },
    peak:    { snow: '#eff2f7', ice: '#d3dbe7', pathColor: '#c9d0da', pathEdge: '#9fabbb', pathCore: '#dbe1e9', deep: '#33689e', shore: '#b8d8e6', props: 'dead' },
    colony:  { snow: '#e7ecf8', ice: '#c6d4ee', pathColor: '#d6c4a2', pathEdge: '#b19f7e', pathCore: '#e4d6ba', deep: '#24548c', shore: '#a8c8e4', props: 'colony' },

    /* ---- tier 2: colder light, harder blues ---- */
    flats:     { snow: '#e7eef8', ice: '#c6d9f0', pathColor: '#d3dae2', pathEdge: '#a7b3c3', pathCore: '#e2e7ed', deep: '#2a5f97', shore: '#aacfe6', props: 'pines' },
    fjord:     { snow: '#e2eef5', ice: '#bcd8ec', pathColor: '#d2c3a2', pathEdge: '#ac9b7c', pathCore: '#e2d5b8', deep: '#14607f', shore: '#96cbd6', props: 'bay' },
    cataracts: { snow: '#e8f5f3', ice: '#c4e2e4', pathColor: '#d8c7a4', pathEdge: '#b6a481', pathCore: '#e5daba', deep: '#1a6d8c', shore: '#9ad2d8', props: 'reeds' },
    shelf:     { snow: '#e8eefa', ice: '#c4d9f2', pathColor: '#ccd4dd', pathEdge: '#a0adbd', pathCore: '#dde3ea', deep: '#255a8e', shore: '#a6cce4', props: 'floes' },
    rookery:   { snow: '#f2f6fc', ice: '#d4e4f4', pathColor: '#e2d1ae', pathEdge: '#bfab86', pathCore: '#eee1c6', deep: '#2b6a9f', shore: '#bbdde8', props: 'village' },
    basin:     { snow: '#8e9bbc', ice: '#66739c', pathColor: '#525d84', pathEdge: '#3a4467', pathCore: '#616c92', deep: '#22375c', shore: '#546d94', props: 'crystals', glow: '#7fb8f5' },
    sable:     { snow: '#e0e8f2', ice: '#bccce2', pathColor: '#c0cad6', pathEdge: '#96a3b4', pathCore: '#d3dae3', deep: '#2c6194', shore: '#aecde3', props: 'dead' },
    floes:     { snow: '#e6f1fb', ice: '#bedbf2', pathColor: '#ccd8e0', pathEdge: '#9fb0c0', pathCore: '#dde6ec', deep: '#1c5f9a', shore: '#9fcbe8', props: 'floes' },
    stormwall: { snow: '#eaeff6', ice: '#cad6e6', pathColor: '#bcc7d4', pathEdge: '#92a0b2', pathCore: '#d0d9e3', deep: '#2e6395', shore: '#b0d1e4', props: 'dead' },
    longdark:  { snow: '#7f8cb0', ice: '#5a688f', pathColor: '#48547a', pathEdge: '#323c5d', pathCore: '#565f86', deep: '#1c2f52', shore: '#495f88', props: 'crystals', glow: '#6fa8ea' },

    /* ---- tier 3: the far ice — deepest colour, most dramatic ---- */
    approach:  { snow: '#dde5f2', ice: '#b6c8e4', pathColor: '#c0cad8', pathEdge: '#94a1b5', pathCore: '#d3dbe6', deep: '#204f86', shore: '#a2c4e0', props: 'pines' },
    causeway:  { snow: '#dbecf4', ice: '#aed4e8', pathColor: '#cbbc98', pathEdge: '#a59674', pathCore: '#dcceac', deep: '#0f5a7c', shore: '#8ec6d4', props: 'bay' },
    trench:    { snow: '#d6eaf1', ice: '#a6cede', pathColor: '#bcc6ca', pathEdge: '#909ba2', pathCore: '#ccd5d9', deep: '#0a4a68', shore: '#84bdcf', props: 'bay' },
    obsidian:  { snow: '#7c88ae', ice: '#54628c', pathColor: '#424e74', pathEdge: '#2c3655', pathCore: '#4e5980', deep: '#182a4c', shore: '#425882', props: 'crystals', glow: '#6f9ce8' },
    cathedral: { snow: '#dee3f8', ice: '#b4c2ee', pathColor: '#c8bda6', pathEdge: '#a1957c', pathCore: '#d9cfb8', deep: '#20488c', shore: '#9fbde6', props: 'crystals', glow: '#9ce8d4' },
    maelstrom: { snow: '#d6e0f2', ice: '#aec2e4', pathColor: '#b8c4d2', pathEdge: '#8c9aac', pathCore: '#ccd5e0', deep: '#1e5290', shore: '#9cc2e2', props: 'floes' },
    icefall:   { snow: '#e0eaf4', ice: '#b8cee6', pathColor: '#b6c2ce', pathEdge: '#8a98a8', pathCore: '#cad3dd', deep: '#255d92', shore: '#a6cbe4', props: 'dead' },
    blackice:  { snow: '#6d7aa2', ice: '#485680', pathColor: '#37436a', pathEdge: '#232c49', pathCore: '#424d73', deep: '#132342', shore: '#374d76', props: 'crystals', glow: '#5f92e2' },
    throne:    { snow: '#dbe1f6', ice: '#aebcec', pathColor: '#bfb5a2', pathEdge: '#988d76', pathCore: '#d2c7b2', deep: '#1c4386', shore: '#98b8e4', props: 'colony' },
    worldsend: { snow: '#d2dbf0', ice: '#a5b6e2', pathColor: '#b4ac98', pathEdge: '#8d846e', pathCore: '#c8bfa8', deep: '#173c7e', shore: '#8eb0e0', props: 'colony' },
  };
